...
//          markedDateIconOffset: 3,
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              FutureBuilder(future: userOders, builder: (BuildContext context, AsyncSnapshot<OrderByBetweendatesResponse> snapshot) {
                ...
                if(snapshot.connectionState == ConnectionState.waiting){
                  ...
                  //  color: Colors.yellow,
                    ...
                    //    debugPrint(DateTime.parse(element.serviceDate.toString()).toString());
                     ...
                     for(int i=0;i< snapshot.data!.patnerresult!.length;i++){
                     //  DateTime date1 = DateTime.utc(day.);
                          DateTime date2 = DateTime.parse(snapshot.data!.patnerresult!.elementAt(i).serviceDate.toString());
                            if((date2.day== day.day)&& (date2.month==day.month)){
                           //   debugPrint(day.toIso8601String());
                    ...
                    if(isToday) {
                      return Center(
                        child: Container(color: service==null? Colors.red:service.serviceToday=="Weekly"?Colors.green: service.serviceToday=="MonthlyTwice"?Colors.blue:service.serviceToday=="MonthlyOnce"?Colors.pink:Colors.red,
                        //  height: 50,
                       //   width: 50,
             ...
             //
              ...
              _service==null?SizedBox.shrink():Padding(
                ...
                child: Container(child: Column(children: [
                  ...
                  Row(
                    ...
                    children: [
                    Text("Service Date") ,
                    Text(_service!.serviceDate!.day.toString()+"-"+_service!.serviceDate!.month.toString()+"-"+_service!.serviceDate!.year.toString())
                  ],),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  ...
                  Column(
                    ...
                    children: [
                    Text("Before Images ") ,
                    SizedBox(height: 150,width: double.infinity,child: ListView.builder(scrollDirection: Axis.horizontal,shrinkWrap: true,itemCount: _service!.beforeImages!.length, itemBuilder: (BuildContext context, int index) {


                      return Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Image.network("https://corgi-humane-completely.ngrok-free.app/api/v1/"+_service!.beforeImages!.elementAt(index),height: 100,width: 100,),
                      );
                    },),)
                  ],),
                  Column(
                    ...
                    children: [
                    Text("After Images ") ,
                    SizedBox(height: 150,width: double.infinity,child: ListView.builder(scrollDirection: Axis.horizontal,shrinkWrap: true,itemCount: _service!.afterImages!.length, itemBuilder: (BuildContext context, int index) {


                      return Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Image.network("https://corgi-humane-completely.ngrok-free.app/api/v1/"+_service!.afterImages!.elementAt(index),height: 100,width: 100,),
                      );
                    },),)
                  ],),
                  Row(
                    ...
                    children: [
                      Text("Start Time ") ,
                      _service!.startTime==null?Text("") :    Text(TimeOfDay.fromDateTime(DateTime.parse(_service!.startTime)).toString())
                    ],),
                  ...
                  Row(
                    ...
                    children: [
                      Text("End Time ") ,
                      _service!.endTime==null?Text("") :     Text(TimeOfDay.fromDateTime(DateTime.parse(_service!.endTime)).toString())
                    ],),
  ...
  getOrder(DateTime StartDate,DateTime EndDate){
   ...
   return ApiProvider(context).getOrderByDates(OrderByBetweendatesResquest(userId: SharePref().getUser()!.id.toString(),endDate: EndDate,date: StartDate)).then((value) {
